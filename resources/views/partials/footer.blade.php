...
<footer class=" text-center color-darkwhite">
      ...
      <section class="">
        <form action="">
          ...
          <div class="row d-flex justify-content-center">
            ...
            <div class="col-auto">
              <p class="pt-2">
                <strong>Hai qualche Problema? Contattaci qui</strong>
              </p>
            </div>
            <!--Grid column-->
            ...
            <div class="col-md-5 col-12">
              ...
              <div class="form-outline form-white mb-4">
                ...
                <label class="form-label" for="form5Example2">Your Email address</label>
              </div>
            </div>
            <!--Grid column-->
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
      © 2020 Copyright:
      <a class="color-darkwhite" href="https://mdbootstrap.com/">Deliveboo.com</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
