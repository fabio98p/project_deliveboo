                        ...
                        <div class="">
                            ...
                            <form method="POST"
                                ...
                                <div class="form-group column">
                                    <label for="name"
                                        class="col-md-4 col-form-label label-personal">{{ __('Nome') }}</label>

                                    <div class="col-md-12">
                                        <input id="name" type="text"
                                            class="form-control input-personal @error('name') is-invalid @enderror"
                                ...
                                <div class="form-group column">
                                    <label for="address"
                                        class="col-md-4 col-form-label label-personal">{{ __('Indirizzo') }}</label>

                                    <div class="col-md-12">
                                        <input id="address" type="text"
                                            class="form-control input-personal @error('address') is-invalid @enderror"
                                ...
                                <div class="form-group column">
                                    <label for="description"
                                        class="col-md-4 col-form-label label-personal">{{ __('Descrizione') }}</label>

                                    <div class="col-md-12">
                                        <textarea id="description" type="description"
                                            class="form-control @error('description') is-invalid @enderror"
                                            name="description" required
                                            autocomplete="description">{{ old('description', $restaurant->description) }}</textarea>
                                ...
                                <div class="form-group column pos-rel">
                                    <label for="categories"
                                        class="col-md-4 col-form-label label-personal">{{ __('Categoria') }}</label>
                                    <div class="col-md-12">
                                        <div class="selectBox">
                                            <select>
                                            ...
                                            @foreach ($categories as $index => $category)
                                                <label>
                                                    <input type="checkbox" name="category_ids[]"
                                                        value="{{ $category->id }}"
                                                        {{ $restaurant->categories->contains($category) ? 'checked' : '' }} />{{ $category->name }}</label>
                                            @endforeach
                                        </div>
                                    </div>
                                ...
                                <div class="form-group column">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control-file @error('logo') is-invalid @enderror" id="logo"
                                            name="logo" type="file">
                                        @error('logo')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="form-group column">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control-file @error('banner') is-invalid @enderror" id="banner"
