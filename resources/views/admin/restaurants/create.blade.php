                        ...
                        <div class="col-md-12">
                            <div class="page-top">
                                ...
                                <div class="my-buttons-container">
                                    <a class="my-button-responsive-show my-button-orange" href="{{route('admin.restaurants.index')}}">
                                        Torna ai ristoranti
                                    </a>
            
                                    <a class="my-button-responsive-hide my-button-orange" href="{{route('admin.restaurants.index')}}"><i class="fas fa-chevron-left"></i></a>
                                </div>
                            </div>
                        </div>
