            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-6">
                <div class="checkout-card show-dish">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-top">
                                <h2>{{ $dish['name'] }} <i class="fas fa-circle" :class="({{$dish->available}} == 1) ? 'text-green' : 'text-red' "></i></h2>
                                <a class="my-button-responsive-show my-button-orange" href="{{route('admin.restaurants.show', ['restaurant' => $restaurant->slug])}}">Torna al ristorante</a>
                    ...
                    <div class="row show-dish-image justify-content-center checkout-card-inner">
                        <div class="col-md-12 d-flex justify-content-center">
                            <div class="show-dish-banner" style="background-image: url('{{asset($dish->image)}}')"></div>
                    ...
                    <div class="row checkout-card-inner justify-content-center">
                        <a class="my-button-responsive-show my-button-blue mr-2" href="{{route('admin.dishes.edit', ['dish' => $dish->slug])}}">Modifica piatto</a>
                        <a class="my-button-responsive-show my-button-red ml-2" name="button" @click="deleteForm = true">Cancella piatto</a>

                        {{-- buttons che appaiono solo su tablet/mobile --}}
                        <a class="my-button-responsive-hide my-button-blue mr-2" href="{{route('admin.dishes.edit', ['dish' => $dish->slug])}}"><i class="fas fa-edit"></i></a>
                        <a class="my-button-responsive-hide my-button-red ml-2" name="button" @click="deleteForm = true"><i class="fas fa-trash-alt"></i></a>
                    </div>
                </div>
            </div>
        </div>
